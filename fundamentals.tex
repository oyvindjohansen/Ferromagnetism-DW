...
This integrand can be rewritten in a tensor form \cite{krüger2006current}. Using the relation
...
This is the case for ellipsoidal bodies \cite{krüger2006current}. This form of the demagnetization energy is similar to that of the uniaxial anisotropic energy in \eqref{eq:uniaxialanisotropy}.

\subsection{Zeeman energy}
The Zeeman energy describes the energy from the interaction between the magnetization of the magnet and an external field $\vec{H}_{Z}$. The Zeeman energy is on the same form as the demagnetization energy in \eqref{eq:demagenergy}, with the internally generated demagnetization field replaced with the external magnetic field:
...
To find the total exchange energy in the magnet we integrate over the volume of the magnet, so that
