...
H_{DM} = \sum_{\langle i,j \rangle} \vec{D}_{ij} \cdot (\vec{M}_i\times\vec{M}_j),
\end{align}
...
\begin{align}
\epsilon_{DM} = \sum_i\vec{D}_{x_i}a_i\cdot(\vec{M}\times\frac{\partial \vec{M}}{\partial x_i}).
\end{align}
...
\begin{align}
\nonumber \epsilon_{DM} &= -D \left[ \hat{x}\cdot(\vec{M}\times\frac{\partial\vec{M}}{\partial x}) + \hat{y}\cdot(\vec{M}\times\frac{\partial\vec{M}}{\partial y}) + \hat{z}\cdot (\vec{M}\times\frac{\partial\vec{M}}{\partial z})\right] \\
\nonumber &= D\left[M_x(\frac{\partial M_z}{\partial y} - \frac{\partial M_y}{\partial z}) + M_y(\frac{\partial M_x}{\partial z} - \frac{\partial M_z}{\partial x}) + M_z(\frac{\partial M_x}{\partial y} - \frac{\partial M_y}{\partial x})\right] \\
&= D \vec{M}\cdot(\nabla\times\vec{M}).
\end{align}
...
\begin{align}
\vec{D}_x &= \frac{D}{a_x} \hat{y}, \\
\vec{D}_y &= - \frac{D}{a_y} \hat{x}, \\
\vec{D}_z &= 0,
\end{align}
...
\epsilon_{DM} &= D\left[ \hat{y} \cdot(\vec{M}\times\frac{\partial\vec{M}}{\partial x}) - \hat{x} \cdot(\vec{M}\times\frac{\partial\vec{M}}{\partial y})\right] \\
...
%\begin{align}
%\epsilon = \left(A\left[ (\frac{\partial \theta}{\partial \rho})^2+\frac{\sin^2\theta}{\rho^2}\right] - |D|(\frac{\partial\theta}{\partial\rho} + \frac{\sin 2\theta}{2\rho}) + K\cos^2\theta\right)\rho
%\end{align}

%\begin{align}
%\left[A(\frac{\partial^2\theta}{\partial\rho^2} + \frac{1}{\rho}\frac{\partial\theta}{\partial\rho} - \frac{\sin\theta\cos\theta}{\rho^2})-|D|\frac{\sin^2\theta}{\rho}+K\sin\theta\cos\theta\right]\rho = 0
%\end{align}
